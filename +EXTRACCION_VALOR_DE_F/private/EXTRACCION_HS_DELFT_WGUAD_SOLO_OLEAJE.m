function Hs=EXTRACCION_HS_DELFT_WGUAD_SOLO_OLEAJE(coord,j)
...
%     files=ls(['..\SIMULACIONES\RESULTADOS\RESULTADOS_MUESTRA\ODSV\Sim_ODSV_SP_sintetica_' num2str(j) '\*.tab']); 
%     data=load(['..\SIMULACIONES\RESULTADOS\RESULTADOS_MUESTRA\ODSV\Sim_ODSV_SP_sintetica_' num2str(j) '\' files(1,:)]);
%     
...
%         data=load(['..\SIMULACIONES\RESULTADOS\RESULTADOS_MUESTRA\ODSV\Sim_ODSV_SP_sintetica_' num2str(j) '\' files(k,:)]);
%         Hs(k)=data(pos,4);
%     end
%     
% %     figure
