...
elseif  comp_oleaje==0 && comp_m_meteo==1 && comp_oleaje_desembocadura==1 && comp_oleaje_desembocadura_sin_viento==0 % Caso 4 Tengo Oleaje en la desembocadura con viento más marea meteorológica    
