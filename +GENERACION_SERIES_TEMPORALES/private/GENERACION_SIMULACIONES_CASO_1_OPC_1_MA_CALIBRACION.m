function GENERACION_SIMULACIONES_CASO_1_OPC_1_MA_CALIBRACION(Forzamiento,t_ini_sim,t_fin_sim,NP)
...
if exist(['..\SIMULACIONES\DATOS\SIMULACIONES_CALIBRACION\Sim_' fold_name '\' NP '\' sim_calibracion],'dir')==7
    ...
    %Sim_sintetica
    destination=['..\SIMULACIONES\DATOS\SIMULACIONES_CALIBRACION\Sim_' fold_name '\' NP '\' sim_calibracion];
